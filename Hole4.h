...
// Arc centre of curvature at (H4_CX, H4_CZ).
// Tee at angle=0 (east), cup at angle=H4_T0 (north-west).
static const float H4_CX   = -37.0f;
static const float H4_CZ   = -11.0f;
static const float H4_RI   =   7.0f;
static const float H4_RO   =  11.0f;
static const float H4_T0   =  -1.41f;  // cup end angle (~-81°, NW)
static const float H4_T1   =   0.0f;   // tee end angle (east)
