...
static const float H7_X0    = -16.0f;  // tee x (west entry)
static const float H7_RA    =   5.0f;  // arc radius (centre of fairway)
static const float H7_LS    =   3.0f;  // straight sections at tee/cup ends
