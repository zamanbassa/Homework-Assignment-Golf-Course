...
static const float H12_TEE_Z = (H12_AZN + H12_AZS) * 0.5f;           //  -9.0
static const float H12_CUP_X = H12_CXW + 2.0f;                       // 32.0
static const float H12_CUP_Z = (H12_CZN + H12_CZS) * 0.5f;           //  -3.0
...
void Hole12::render(const mat4& vp) const {
    ...
    drawFloor12(mQuad, vp, H12_AXW, H12_AXE, H12_AZN, H12_AZS, 8);  // A — top arm
    drawFloor12(mQuad, vp, H12_BXW, H12_BXE, H12_BZN, H12_BZS, 8);  // B — connector
    drawFloor12(mQuad, vp, H12_CXW, H12_CXE, H12_CZN, H12_CZS, 8);  // C — bottom arm
